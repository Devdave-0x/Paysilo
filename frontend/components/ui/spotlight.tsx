...
/**
 * Cursor-tracked radial glow. Verbatim logic from the 21st.dev / ibelick
 * Spotlight component, recolored to PaySilo's seal accent. Requires its
 * parent to accept position: relative / overflow: hidden, which this
 * component sets automatically on mount.
 */
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "from-seal/40 via-seal/10 to-transparent",
